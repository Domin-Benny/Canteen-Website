...
function _intomepDefault (ex) { return (ex && (typeof ex === 'object') && 'default' in ex) ? ex['default'] : ex; }

var throttle = _intomepDefault(require('lodash.throttle'));
var debounce = _intomepDefault(require('lodash.debounce'));
